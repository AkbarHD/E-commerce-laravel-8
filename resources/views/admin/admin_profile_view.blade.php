            ...
            <div class="row">
                <div class="box box-widget widget-user">
					...
					<div class="widget-user-image">
					  <img class="rounded-circle" style="width: 85px; height: 85px;" src="{{ (!empty($adminData->profile_photo_path)) ? asset('upload/admin_images/' . $adminData->profile_photo_path) : asset('upload/no_images.jpg') }}"alt="User Avatar">
					</div>
